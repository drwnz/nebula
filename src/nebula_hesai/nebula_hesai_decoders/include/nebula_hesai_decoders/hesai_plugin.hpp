...
#ifndef NEBULA_HESAI_PLUGIN_HPP
#define NEBULA_HESAI_PLUGIN_HPP
...
{
class HesaiSensorDecoderRuntime : public SensorDecoderRuntime
{
public:
  HesaiSensorDecoderRuntime();
...
private:
  std::unique_ptr<HesaiDriver> driver_;
...
class HesaiSensorPlugin : public SensorPlugin
{
public:
