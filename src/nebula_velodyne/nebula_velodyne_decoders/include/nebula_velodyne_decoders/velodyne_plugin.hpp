...
#ifndef NEBULA_VELODYNE_PLUGIN_HPP
#define NEBULA_VELODYNE_PLUGIN_HPP
...
{
class VelodyneSensorDecoderRuntime : public SensorDecoderRuntime
{
public:
  VelodyneSensorDecoderRuntime();
...
private:
  std::unique_ptr<VelodyneDriver> driver_;
...
class VelodyneSensorPlugin : public SensorPlugin
{
public:
...
#endif  // NEBULA_VELODYNE_PLUGIN_HPP
