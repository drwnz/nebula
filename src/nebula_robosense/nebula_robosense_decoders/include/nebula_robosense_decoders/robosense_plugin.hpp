...
#ifndef NEBULA_ROBOSENSE_PLUGIN_HPP
#define NEBULA_ROBOSENSE_PLUGIN_HPP
...
{
class RobosenseSensorDecoderRuntime : public SensorDecoderRuntime
{
public:
  RobosenseSensorDecoderRuntime();
...
#endif  // NEBULA_ROBOSENSE_PLUGIN_HPP
