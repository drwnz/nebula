...
#ifndef NEBULA_CONTINENTAL_ARS548_PLUGIN_HPP
#define NEBULA_CONTINENTAL_ARS548_PLUGIN_HPP
...
private:
  ...
  void on_objects(std::shared_ptr<continental_msgs::msg::ContinentalArs548ObjectList> msg);
};

class ContinentalARS548SensorPlugin : public SensorPlugin
{
public:
...
#endif  // NEBULA_CONTINENTAL_ARS548_PLUGIN_HPP
