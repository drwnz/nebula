...
#ifndef NEBULA_CONTINENTAL_SRR520_PLUGIN_HPP
#define NEBULA_CONTINENTAL_SRR520_PLUGIN_HPP
...
private:
  ...
  void on_objects(std::shared_ptr<continental_msgs::msg::ContinentalSrr520ObjectList> msg);
};

class ContinentalSRR520SensorPlugin : public SensorPlugin
{
public:
...
#endif  // NEBULA_CONTINENTAL_SRR520_PLUGIN_HPP
